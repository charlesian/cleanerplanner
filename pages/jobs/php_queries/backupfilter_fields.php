...
// http://localhost/cleaner/pages/jobs/php_queries/filter.php?filter_round=new%20round&filter_service=new%20service&filter_due_dates=Due%20Tomorrow&filter_due_date_from=&filter_due_date_to=&filter_quote=Active&headertext%5B0%5D%5B%5D=&headertext%5B0%5D%5B%5D=Due&headertext%5B0%5D%5B%5D=Worksheet&headertext%5B0%5D%5B%5D=New&headertext%5B0%5D%5B%5D=&headertext%5B0%5D%5B%5D=&headertext%5B0%5D%5B%5D=&headertext%5B0%5D%5B%5D=Job%20Ref&headertext%5B0%5D%5B%5D=Cust%20Ref&headertext%5B0%5D%5B%5D=Address%201&headertext%5B0%5D%5B%5D=&headertext%5B0%5D%5B%5D=Schedule
...
if($filter_round == 'All Rounds' && $filter_service == 'All Services' && $filter_due_dates == 'Custom' && $filter_quote =='All Statuses' && $filter_due_date_from != '' && $filter_due_date_to != '')
{ 	
	$select = mysqli_query($conn,"SELECT $columns,$detault_values FROM tbl_customer tc LEFT JOIN tbl_jobs tj on tj.customer_id = tc.customer_id WHERE obs_sched_date BETWEEN '$filter_due_date_from' AND '$filter_due_date_to' ORDER BY jobs_sched_date DESC ");
